...
#define FFMPEG_CONFIGURATION "--disable-all --disable-autodetect --disable-iconv --enable-avcodec --enable-avutil --enable-bsfs --enable-gpl --enable-static --arch=aarch64 --enable-cross-compile"
